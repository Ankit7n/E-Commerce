          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-xl shadow-[0_4px_24px_rgba(0,0,0,0.06)] px-xl py-sm">
            <div className="mb-xl">
              ...
              <p className="font-body-md text-body-sm text-on-surface-variant">
                Register yourself to access the commerce dashboard.
              </p>
            </div>
            <form className="space-y-lg" onSubmit={handleSubmit}>
              ...
              <div className="space-y-xs">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-11 pr-md py-md bg-white border border-outline-variant rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-body-md text-body-md tracking-[0.2em]"
                    maxLength="4"
                    placeholder="0000"
                    type="number"
                    name="adminCode"
                ...
                <p className="font-body-sm text-body-sm text-outline px-sm">
